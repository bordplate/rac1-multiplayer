...
LOADER_INJECT_ADDR 					= 0x014D4C # nop in main()
LOADER_START_ADDR 					= 0x5F7150 # 0x5F7140 + 4 + align16
LOADER_END_ADDR 					= 0x5F71D0 # LOADER_START_ADDR + 0x80
LOADER_SYS_PRX_MODULE_LOAD_ADDR 	= 0x650544 # cellPrxForUser _sys_process_at_Exitspawn 0x96328741
LOADER_SYS_PRX_MODULE_START_ADDR 	= 0x6506a4 # cellPrxForUser sys_prx_load_module

# 1414 instructions, around ~375 hooks
HOOK_SHARED_TEXT_BEGIN_ADDR = $(LOADER_END_ADDR)
HOOK_SHARED_TEXT_END_ADDR 	= 0x5F8758 # HOOK_SHARED_TEXT_BEGIN_ADDR + 0x1588
