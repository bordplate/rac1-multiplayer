...
#define BULLSHIT_ITEM_ARRAY ((u8*)0xB00002)
#define BULLSHIT_ITEM_ARRAY_SIZE 512 // placeholder value generated by copilot
SHK_HOOK(void, _unlock_item, int, uint8_t);
void _unlock_item_hook(int item_id, uint8_t equip) {
    BULLSHIT_ITEM_ARRAY[item_id] = true; // Ensure the item is unlocked locally as well
